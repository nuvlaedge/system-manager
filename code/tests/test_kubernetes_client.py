...
class KubernetesTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        with mock.patch.dict(sys.modules):
            # sys.modules.clear()
            if 'system_manager.common.ContainerRuntime' in sys.modules:
                del sys.modules['system_manager.common.ContainerRuntime']
    ...
    @mock.patch('system_manager.common.ContainerRuntime.Kubernetes.get_version')
